...
> Based on best practices from production forms
...
For runtime testing, you need dev credentials configured in the parent runtime-app:
...
**IMPORTANT**: This file is in `.gitignore` and must be created locally. See [DEVELOPMENT.md](../DEVELOPMENT.md#setup-de-credenciales-de-desarrollo) for full setup instructions.

### Required Environment Variables

**File**: `../../runtime-app/.env.local`
